...
if("TRUE" STREQUAL "TRUE")
  set(iq_sim_SOURCE_PREFIX /home/neha/loc_ws/src/UAV-Localization/iq_sim)
  set(iq_sim_DEVEL_PREFIX /home/neha/loc_ws/devel)
  set(iq_sim_INSTALL_PREFIX "")
  set(iq_sim_PREFIX ${iq_sim_DEVEL_PREFIX})
else()
  set(iq_sim_SOURCE_PREFIX "")
  set(iq_sim_DEVEL_PREFIX "")
  set(iq_sim_INSTALL_PREFIX /home/neha/loc_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'iq_sim' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/neha/loc_ws/src/UAV-Localization/iq_sim/${idir}'.  ${_report}")
    endif()
